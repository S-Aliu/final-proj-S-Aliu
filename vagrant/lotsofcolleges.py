...
from database_setup import College, Region, Base, User, Tours
...
# USC tours
tour1 = Tours(type = "Campus", date = "https://www.cvent.com/c/calendar/773fa44c-0100-4b1b-a1d0-90ad731a689a", popularity = "7/10", weather = "warm windy spring, hot summers, mild winter", virtual_tour = "https://www.youvisit.com/tour/113805/131407/", notes = "I enjoyed this tour" )

# Williams tours
tour2 = Tours(type = "Flyin", date = "https://admission.williams.edu/visit/tours-information-sessions/", popularity = "5/10", weather = "humid continental climate, with warm summers and cold, snowy winters", virtual_tour = "https://map.williams.edu/?id=640#!m/73627?ce/7262?ct/8158,0", notes = "your thoughts here" )

#Uni of IOWA
tour3 = Tours(type = "Campus", date = "https://www.maui.uiowa.edu/maui/pub/admissions/events/register-student.page?date=2019-04-17", popularity = "4/10", weather = "hot summers and cold, snowy winters, fall is the nicest seaspn", virtual_tour = "none", notes = "Your thoughts here")
